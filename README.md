...
- **0-Foundations**
  - [x] [0.0 Memory Fundamentals](https://github.com/euotiniel/inside-the-chain/blob/main/0-foundations/0.0-memory/index.md)
...
|---|---|---|
| **Foundations** | Computing fundamentals needed to understand machines, execution, storage and networks | `memory` · `operating-systems` · `networking` · `processes-and-concurrency` · `compilers-lite` · `storage-systems` · `algorithms` · `data-structures` |
